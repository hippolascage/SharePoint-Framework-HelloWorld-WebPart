...
describe('Guid tests', function () {
    ...
    var invalidGuids = [
        ...
        '{not-a-guid}',
        'Guid(not-a-guid)',
        '1158fbf1-8dac-5252-b378-77489fd230d8',
        '1158fbf1-8dac-4252-6378-77489fd230d8',
    ...
    describe('Instance methods', function () {
        it('Can be converted into a string', function () {
            ...
            var guid = Guid_1.default.tryParse(guidString);
            chai_1.expect(guid.toString() === guidString);
        });
        it('Can compare two Guids', function () {
            var guidA = Guid_1.default.newGuid();
            var guidB = Guid_1.default.tryParse(validGuids[0]);
            var guidC = Guid_1.default.tryParse(validGuids[0]);
