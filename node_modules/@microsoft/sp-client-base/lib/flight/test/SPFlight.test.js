...
describe('SPFlight tests', function () {
    var undefinedFlights = undefined;
    /* tslint:disable:no-null-keyword */
    var nullFlights = null;
    ...
    it('Can parse an undefined flights array', function () {
        SPFlight_1.default.initialize(undefinedFlights);
        assert.isTrue(true);
    });
    it('Can parse a null flights array', function () {
        SPFlight_1.default.initialize(nullFlights);
        assert.isTrue(true);
    });
    ...
    it('Can parse a valid flights array', function () {
        ...
        describe('Valid SPFlight Array tests', function () {
            it('Can find flights contained in SPFlight object', function () {
                assert.isTrue(SPFlight_1.default.isEnabled(764));
                assert.isTrue(SPFlight_1.default.isEnabled(18));
                assert.isTrue(SPFlight_1.default.isEnabled(573));
            });
            it('Cannot find flights not contained in a valid flights array', function () {
                assert.isTrue(!SPFlight_1.default.isEnabled(134));
                assert.isTrue(!SPFlight_1.default.isEnabled(55));
            });
            it('Cannot find a null flight in a valid flights array', function () {
                /* tslint:disable:no-null-keyword */
                assert.isTrue(!SPFlight_1.default.isEnabled(null));
                /* tslint:enable:no-null-keyword */
            });
            it('Cannot find an undefined flight in a valid flights array', function () {
                assert.isTrue(!SPFlight_1.default.isEnabled(undefined));
            });
        });
        assert.isTrue(true);
    });
...
//# sourceMappingURL=SPFlight.test.js.map
