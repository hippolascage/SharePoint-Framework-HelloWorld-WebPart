...
export default class SPPermission {
     ...
     */
    static emptyMask: SPPermission;
    /**
     * View items in lists, documents in document libraries, and view Web discussion comments.
     */
    static viewListItems: SPPermission;
    /**
     * Add items to lists, add documents to document libraries, and add Web discussion comments.
     */
    static addListItems: SPPermission;
    /**
     ...
     */
    static editListItems: SPPermission;
    /**
     * Delete items from a list, documents from a document library, and Web discussion comments in documents.
     */
    static deleteListItems: SPPermission;
    /**
     * Approve a minor version of a list item or document.
     */
    static approveItems: SPPermission;
    /**
     * View the source of documents with server-side file handlers.
     */
    static openItems: SPPermission;
    /**
     * View past versions of a list item or document.
     */
    static viewVersions: SPPermission;
    /**
     * Delete past versions of a list item or document.
     */
    static deleteVersions: SPPermission;
    /**
     * Discard or check in a document which is checked out to another user.
     */
    static cancelCheckout: SPPermission;
    /**
     * Create, change, and delete personal views of lists.
     */
    static managePersonalViews: SPPermission;
    /**
     * Create and delete lists, add or remove columns in a list, and add or remove public views of a list.
     */
    static manageLists: SPPermission;
    /**
     * View forms, views, and application pages, and enumerate lists.
     */
    static viewFormPages: SPPermission;
    /**
     * Allow users to open a Web site, list, or folder to access items inside that container.
     */
    static open: SPPermission;
    /**
     * View pages in a Web site.
     */
    static viewPages: SPPermission;
    /**
     * View the layouts page?
     */
    static layoutsPage: SPPermission;
    /**
     * Add, change, or delete HTML pages or web part Pages, and edit the Web site using a SharePoint
     * Foundation–compatible editor.
     */
    static addAndCustomizePages: SPPermission;
    /**
     * Apply a theme or borders to the entire Web site.
     */
    static applyThemeAndBorder: SPPermission;
    /**
     * Apply a style sheet (.css file) to the Web site.
     */
    static applyStyleSheets: SPPermission;
    /**
     * View reports on Web site usage.
     */
    static viewUsageData: SPPermission;
    /**
     * Create a Web site using Self-Service Site Creation.
     */
    static createSSCSite: SPPermission;
    /**
     * Create subsites such as team sites, Meeting Workspace sites, and Document Workspace sites.
     */
    static manageSubwebs: SPPermission;
    /**
     * Create a group of users that can be used anywhere within the site collection.
     */
    static createGroups: SPPermission;
    /**
     * Create and change permission levels on the Web site and assign permissions to users and groups.
     */
    static managePermissions: SPPermission;
    /**
     * Enumerate files and folders in a Web site using Microsoft Office SharePoint Designer 2007 and WebDAV interfaces.
     */
    static browseDirectories: SPPermission;
    /**
     * View information about users of the Web site.
     */
    static browserUserInfo: SPPermission;
    /**
     * Add or remove personal web parts on a web part Page.
     */
    static addDelPrivateWebParts: SPPermission;
    /**
     * Update web parts to display personalized information.
     */
    static updatePersonalWebParts: SPPermission;
    /**
     ...
     */
    static manageWeb: SPPermission;
    /**
     * Use features that launch client applications; otherwise, users must work on documents locally and upload changes.
     */
    static useClientIntegration: SPPermission;
    /**
     * Use SOAP, WebDAV, or Microsoft Office SharePoint Designer 2007 interfaces to access the Web site.
     */
    static useRemoteAPIs: SPPermission;
    /**
     * Manage alerts for all users of the Web site.
     */
    static manageAlerts: SPPermission;
    /**
     * Create e-mail alerts.
     */
    static createAlerts: SPPermission;
    /**
     * Allows a user to change his or her user information, such as adding a picture.
     */
    static editMyUserInfo: SPPermission;
    /**
     * Enumerate permissions on the Web site, list, folder, document, or list item.
     */
    static enumeratePermissions: SPPermission;
    /**
     * Has all permissions on the Web site. Not available through the user interface.
     */
    static fullMask: SPPermission;
    private _value;
