...
var createWebPartXml_1 = require('./createWebPartXml');
...
function createFeatureXml(feature, resources) {
    ...
    var webpartsXml = [];
    for (var componentId in feature.components) {
        if (feature.components[componentId]) {
            var component = feature.components[componentId];
            if (component.type === ComponentType_1.default.WebPart) {
                webpartsXml.push(createWebPartXml_1.default(component, feature.id));
            }
        }
    }
    ...
    })).concat(webpartsXml.map(function (webpart) {
        return {
