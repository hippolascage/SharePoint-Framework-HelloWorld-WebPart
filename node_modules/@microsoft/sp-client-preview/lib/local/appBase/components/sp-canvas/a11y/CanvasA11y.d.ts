...
export declare function isEscape(e: KeyboardEvent | ReactKeyboardEvent): boolean;
export declare function isEnter(e: KeyboardEvent | ReactKeyboardEvent): boolean;
export declare function isShiftTab(e: KeyboardEvent | ReactKeyboardEvent): boolean;
export declare function isTab(e: KeyboardEvent | ReactKeyboardEvent): boolean;
export declare function isKey(keyCode: number, e: KeyboardEvent | ReactKeyboardEvent, allowAlt?: boolean, allowCtrl?: boolean, allowShift?: boolean): boolean;
