...
export default class ToolBoxItemClassifier {
    private _toolBoxItemIdToPropsMap;
    /**
     ...
     */
    registerItem(itemId: string, itemProps: IToolboxItemProps): void;
    /**
     ...
     */
    classify(isFeatured: boolean, sortPredicate?: (x: IToolboxItemProps, y: IToolboxItemProps) => number): Array<IToolboxItemProps>;
}
