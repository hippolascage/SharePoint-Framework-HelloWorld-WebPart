...
export declare class PerformanceDisplayStore extends BaseStore {
    private static _instance;
    static instance: PerformanceDisplayStore;
    /**
     ...
     */
    private _getReadableWebpartName(id);
}
declare var _default: PerformanceDisplayStore;
