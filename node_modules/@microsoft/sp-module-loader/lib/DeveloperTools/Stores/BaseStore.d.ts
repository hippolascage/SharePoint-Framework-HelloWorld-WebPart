...
export default class BaseStore {
    ...
    addProcessActionCallback(callback: ((action: IAction) => void)): void;
     ...
     */
    dispose(): void;
    private onActionSent(action);
    private tryProcessAction(processActionCallbackFunction, action);
}
